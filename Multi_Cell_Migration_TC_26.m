...
% Model Definitions
runTime = 4*0.5*24*3600;%.........................Total runtime for model (sec)
...
sf = 051;%..................................................Mystery Constant
Fadhv = 600e-10;%...............................Adhesive strength constant (N) 1e-8
Fcomp = 300e-10;%........................Compressive force during contact (N) 30e-9
...
%             end
        ...
        for cellOne = 1:nCells 
            for cellTwo = 1:nCells
                ...
                di(cellOne,cellTwo) = sqrt((b(cellOne)*cosd(...
...
if animation == 1
    for j=1:pos-1 %3D Animation plot
        for cell = 1:nCells
            [x,y,z] = ellipsoid(0,0,0,gCellAx(j,1,cell),gCellAx(j,2,cell),gCellAx(j,3,cell));
