    ...
    %                     retracting(cellTwo) = 1;
        ...
        for cellOne = 1:nCells
            for cellTwo = 1:nCells
                ...
                angAvoid(cellOne,cellTwo) = atand(rCell(cell)/nCellDist(cellOne,cellTwo));
...
if animation == 1
    for j=1:pos %3D Animation plot
        for cell = 1:nCells
%             axes_handle = gFiberDir(j,:,cell);
...
%             [x,y,z] = ellipsoid(axes_handle,0,0,0,gCellAx(j,1,cell),gCellAx(j,2,cell),gCellAx(j,3,cell));
