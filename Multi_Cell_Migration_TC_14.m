...
sf = 000;%..................................................Mystery Constant
Fadhv = 300e-10;%...............................Adhesive strength constant (N) 1e-8
...
%         scatter3(randomWalk(j,1,1),randomWalk(j,2,1),randomWalk(j,3,1),'MarkerEdgeColor','m','MarkerFaceColor','m')
%         if nCells > 1 
%             scatter3(randomWalk(j,1,2),randomWalk(j,2,2),randomWalk(j,3,2),'MarkerEdgeColor','b','MarkerFaceColor','b')
%         end
%         if i > 2
%             scatter3(randomWalk(j,1,i),randomWalk(j,2,i),randomWalk(j,3,i),'Color','k')
%         end
...
% %     plot3(random_walk(1:50,1,i),random_walk(1:50,2,i),random_walk(1:50,3,i),'Color','c')
% %     plot3(random_walk(:,1,i),random_walk(:,2,i),random_walk(:,3,i),'Color','b')
% %     addpoints(curve,randomWalk(:,1,1),randomWalk(:,2,1),randomWalk(:,3,1))
