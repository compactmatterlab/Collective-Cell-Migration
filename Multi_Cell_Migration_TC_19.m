...
% Model Definitions
runTime = 1*0.5*24*3600;%.........................Total runtime for model (sec)
...
% contactRange = 0;
% angAvoid = 25;%..........Radial angle of avoidance from extending pseudopod Need paper value
...
%             vPrev(cell,:) = cellPos(pos+1,:,cell)-cellPos(pos,:,cell);
        ...
        if contracting(cell)
            if Lpseudo(cell) <= 0.05 || Lpseudo(cell) > rCell(cell)
