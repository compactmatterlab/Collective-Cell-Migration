...
% Model Definitions
runTime = 0.5*24*3600;%.........................Total runtime for model (sec)
...
RGD = 6.5;%................................RGD Peptides/monomer/tropocollagen
...
%         if -(kT_eff)/(bondsTotal(cell)*kB*T) < -700
%             fb(cell)  = 1e-200;
%         end
%         if fb(cell) == 0
%             error('fb = 0')
